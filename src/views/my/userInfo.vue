    ...
    <div class="">
        ...
        <div class="detail" :model="formData">
            ...
            <div class="clearfix rows">
                ...
                <div class="flr">
                    <input type="text" v-validate="'required|mobile'" name="mobile" v-model="formData.mobile" placeholder="请输入">
                </div>
                <div v-show="errors.has('mobile')" class="error flr">{{ errors.first('mobile')}}</div>

            </div>
            <div class="clearfix rows">
                <div class="fll">电子邮箱</div>
                <div class="flr">
                    <input type="text" v-validate="'required|email'" name="email" v-model="formData.email" placeholder="请输入">
                </div>
                <span v-show="errors.has('email')" class="error langa flr">{{ errors.first('email')}}</span>
            </div>
            <div class="clearfix rows">
                <div class="fll">身份证号</div>
                <div class="flr">
                    <input type="text" v-validate="'required|idcard'" name="idcard" v-model="formData.IDcard" placeholder="请输入">
                </div>
            ...
            <div class="clearfix rows">
                ...
                <i class="iconfont icon-xiangyou flr" @click="showDate = true"></i>
                <div @click="showDate = true">
                    <!-- <span class="areaa flr" v-if="descArea">{{province}},{{city}},{{county}}</span> -->
                    <button class="Area flr">请选择</button>
                </div>
            </div>
            <!-- <mt-datetime-picker 
            ...
            <van-popup v-model="showDate" position="bottom" :overlay="true">
                <van-datetime-picker @cancel="showDate = false" @confirm="onConfirmDate" @change="onChangeDate" type="date" :min-date="minDate"
                />
                <!-- v-model="currentDate" -->
            </van-popup>
            <div class="clearfix rows">
            ...
            <div class="clearfix rows">
                <div class="fll">职位</div>
                <div class="flr">
                    <input type="text" v-model="formData.job" placeholder="请输入">
                </div>
            </div>
            <!-- <div class="clearfix rows">
                <div class="fll">所属行业</div>
                <div class="flr">
                    <select class="oneRows" v-model="formData.industrys" multiple="multiple">
