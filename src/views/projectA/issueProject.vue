        ...
        <div class="detail">
            <div class="itemBox">
                <div class="" :model="formData">
                    ...
                    <div class="rows">
                        <span>所属阶段</span>
                        <select class="oneRows" v-model="stages">
                ...
                <div>
                    ...
                    <mu-flex align-items="center" class="radio">
                        ...
                        <mu-radio class="itemRadio" v-model="formData.financeBody" v-for="item in financeBodyList" name="type" :key="item.dataValue" :value="item.dataValue" :label="item.dataName"></mu-radio>
                    </mu-flex>
                    <div class="rows">
                        <span>企业全称</span>
        ...
        methods: {
            ...
            getData(id) {
                this.$axios.get(`/jsp/wap/center/ctrl/jsonProjectDetail.jsp?id=${id}`).then(res => {
                    ...
                    //     this.industrys = (res.data.project.industryName || "").split(",");
                    // }
                     if (res.data.project.industryStr != '') {
                        this.industrys = (res.data.project.industryStr || "").split(",");
                    }
                    // -----------------------------------------------
