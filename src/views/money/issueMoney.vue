<template>
    <div class="all">
        ...
        <div class="detail" :model="formData">
            ...
            <div class="rows">
                <span>联系电话</span>
                <input type="text" class="oneInput" v-validate="'required|mobile'" name="mobile" v-model="formData.linkmanPhone">
                <span v-show="errors.has('mobile')" class="error">{{ errors.first('mobile')}}</span>
            </div>
            <div class="clearfix rows">
                <div class="fll">投资地区</div>
                <i class="iconfont icon-xiangyou flr" @click="showArea2 = true"></i>
                <div @click="showArea2 = true">
                    <span class="areaa flr">{{province1}},{{city1}},{{county1}}</span>
                </div>
            ...
            <div class="rows">
                ...
                <!-- <van-popup v-model="showDate" position="bottom" :overlay="true">
                    <van-datetime-picker title="请选择" @cancel="showDate = false" @confirm="onConfirmDate" type="year-month" :formatter="formatter"
                        :min-date="minDate" />
                </van-popup> -->
            </div>
            <div class="rows">
            ...
            <div class="rows">
                ...
                <div class="descBox">
                    ...
                    <div v-for="(item,index) in fileList" :key="index"><div>{{item.name}}</div></div>
                </div>
            </div>
        </div>
